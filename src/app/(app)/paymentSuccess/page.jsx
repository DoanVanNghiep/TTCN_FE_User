...
import { getOrderByOrderId } from "@/api/apiOrder"; // Đảm bảo import API đúng
...
const SuccessPaymentPage = () => {
  ...
  const orderId = searchParams.get("orderId"); // Lấy mã đơn hàng từ URL
      ...
      <Card>
        ...
        {loading ? (
          ...
          <>
            ...
            >
              Đơn hàng <b>{orderId}</b> của bạn đã được tạo thành công!
            </Text>
