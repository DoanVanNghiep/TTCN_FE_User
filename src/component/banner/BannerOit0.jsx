  ...
  return (
    <>
      <div className="w-[100vw] relative">
        <img
          style={{ height: "300px" }}
          src={proit.image || "/S8.png"}
          className="w-full h-[73vh] object-cover"
          alt={proit.title || "Banner Image"}
        />
        <div className="laptop:w-[50%] phone:w-[80%] mx-auto text-center absolute top-[15%] left-[50%] translate-x-[-50%] border-[10px] p-[3%] border-primaryColor border-solid text-[#090808]">
